...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run Llava-med on radiology reports.")
    ...
    main(args.model_path, args.image_folder, args.question_file, args.answer_file)
